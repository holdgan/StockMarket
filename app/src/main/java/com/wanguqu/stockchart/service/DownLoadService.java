package com.wanguqu.stockchart.service;
...
import com.wanguqu.stockchart.event.ProgressUpdateEvent;
import com.wanguqu.stockchart.inject.component.DaggerServiceComponent;
import com.wanguqu.stockchart.inject.component.ServiceComponent;
        ...
        subscription = downLoadApi.getDownApk()
                ...
                .flatMap(new Func1<ResponseBody, Observable<Boolean>>() {
                    ...
                    public Observable<Boolean> call(ResponseBody responseBody) {
                        Boolean writtenToDisk = com.wanguqu.stockchart.rxutils.FileUtils.writeResponseBodyToDisk(responseBody, getApplicationContext());
